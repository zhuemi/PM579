...
278/2500 = 0.11
power is the fraction of true positives in all of the positive tests
power is : true discoveries over number of true alternatives

fewer false positives (basically got rid of false positives) after using bonferroni to adjust
not as strict on power, so we don't find as many true positives through this method
